...
**Dernière mise à jour:** 2026-05-12 (Steps 1-38 complétés)
...
- ✅ **Step 38:** Modale d'onboarding — `Modal` React Native au premier lancement, `hasSeenOnboarding` persisté dans Zustand, bouton info dans `AppHeader` pour rouvrir
